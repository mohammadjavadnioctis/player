...
let bottomProressBar1 = document.querySelector('#bottom-progress-bar1')
...
function toggleFullScreen1() {
  ...
  function draw1(video, canvas) {
    console.log('this is coming from VideoForLofeJs1',video)
