...
let bottomProressBar2 = document.querySelector('#bottom-progress-bar2')
...
//sessionStorage.removeItem("Video3WatchPercentage");

function updateprogressBar2() {
  var percentage = Math.floor((100 / player2.duration) * player2.currentTime);
  progressBar2.value = percentage;
  bottomProressBar2.value = percentage;
  progressBar2.innerHTML = percentage + '% played';

  localStorage.setItem("Video3WatchPercentage", percentage);
  localStorage.setItem("Video3EndedTime", player2.currentTime);
}
